...
public class InputValidator 
{
    ...
    private static final Set<String> acceptedMedia = Set.of("oil", "acrylic", "watercolor", "ink", "pastel", "digital", "mixed media", "sculpture");
    ...
    public static boolean validateName(String name) 
    {
        ...
        // we will accept letters (in any language with diacritics)
    }
     ...
     */public static boolean isUsernameUnique(String username, Set<String> existingUsernames) 
    {
        // Check if the username exists in the list
        // Case-insensitive check (UserName" and "username" as two distinct usernames)
        if (existingUsernames == null) 
        {
            throw new IllegalArgumentException("existingUsernames set cannot be null");
        }
